...
yosys -p "read_verilog $SRC_FILES; synth_gowin -json $OUT_DIR/top-synth.json -family gw2a" > build/log.txt
nextpnr-himbaechel -v --debug --json $OUT_DIR/top-synth.json --write $OUT_DIR/top.json --device GW2AR-LV18QN88C8/I7 --vopt family=GW2A-18C --vopt cst=pinout.cst
